#!/usr/bin/env python3
"""
🛡️ SemanticGuard Prompt Optimization V2 - API Model Prompt Builder
...
logger = logging.getLogger("semanticguard.api_prompt_builder")
...
API_SYSTEM_PROMPT_V1_LEGACY = """You are SemanticGuard, a security-focused code auditor. Analyze the provided code for security violations and architectural drift.
