#!/bin/bash
# SemantGuard Server Startup Script (Linux/Mac)
# This script starts the SemantGuard server from the correct directory

echo ""
echo "========================================"
echo "  SEMANTGUARD GATEKEEPER SERVER"
echo "========================================"
echo ""
...
# Start the server
echo "[3/3] Starting SemantGuard server..."
echo ""
...
python -m uvicorn semantguard_server.server:app --reload --host 127.0.0.1 --port 8000
