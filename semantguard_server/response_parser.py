...
logger = logging.getLogger("semantguard.parser")

ERROR_LOG_PATH = os.path.join("logs", "semantguard_parse_errors.jsonl")
...
def _format_violations(json_block: dict, code: str) -> List[dict]:
    """
    Format the JSON block into the SemantGuard Violation schema.
    """
