...
Run: python semantguard_server/benchmark_v1_v2.py
...
from semantguard_server.api_prompt_builder import (
...
def run_benchmark():
    ...
    print(f"\n{'='*70}")
    print(f"SEMANTGUARD API PROMPT BENCHMARK — V1 Legacy vs V2 Constrained")
