@echo off
REM Trepan Server Startup Script (Windows)
REM This script starts the Trepan server from the correct directory
...
echo [3/3] Starting Trepan server...
echo.
...
python -m uvicorn trepan_server.server:app --reload --host 127.0.0.1 --port 8000
