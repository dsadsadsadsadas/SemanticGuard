#!/usr/bin/env python3
"""
🛡️ Trepan Prompt Optimization V2 - API Model Prompt Builder
...
logger = logging.getLogger("trepan.api_prompt_builder")
...
API_SYSTEM_PROMPT_V1_LEGACY = """You are Trepan, a security-focused code auditor. Analyze the provided code for security violations and architectural drift.
